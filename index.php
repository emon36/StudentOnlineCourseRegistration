            ...
            >
              <ul class="animated fadeInUp col-md-12 list-unstyled list-inline">
                ...
                <li class="list-inline-item">
                  <a
                    target=""
                    href="advisor/login.php"
                    class="btn btn-white btn-lg btn-rounded mr-0"
                    >Login As A Advisor</a
                  >
                </li>
                <li class="list-inline-item">
                  <a
                    ...
                    class="btn btn-black btn-lg btn-rounded ml-0"
